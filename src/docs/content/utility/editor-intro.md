Before a player can create a custom %subject%, the game must feature an editor. Luckily, making a Godot %subject% editor is relatively easy thanks to Godot's node structure.
